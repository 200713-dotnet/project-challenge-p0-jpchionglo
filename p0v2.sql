...
values (1, 'Oakwood Branch', 2);

insert into [User].[Login](LoginID, [Username], [Password])
values (3, 'elston','password');

insert into [Store].[Store](StoreID, [Name], LoginID)
values (2, 'Elston Branch', 3);
...
--Sample Order
insert into [Order].[Order](OrderID,DateOrdered,UserID, StoreID, Placed, Completed)
values (1,'07/27/2020 14:36:08', 1, 1, 1, 0)
go

insert into [Order].Pizza(PizzaOrderID, OrderID, PizzaID)
values (1,1,1);
go
